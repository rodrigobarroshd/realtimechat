...
async function handleSignUp(e: React.FormEvent) {
  e.preventDefault(); // OBRIGATÓRIO: impede o refresh da página
  ...
  try {
    ...
    const result = await signIn('credentials', {
      email,
      password,
      redirect: false, // Mantemos false para controlar o sucesso
    })

    if (result?.error) {
      toast.error('Conta criada, mas erro ao logar.')
      router.push('/login')
    } else {
      toast.success('Pronto! Entrando...')
      ...
      >
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center p-8 z-10">
              ...
              >
                <div className="h-12 w-12 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center">
                  <img src="/logo/logo_darkmod_realtimechat.png"></img>
                </div>
              </motion.div>
              <motion.h2 
                initial={{ opacity: 0, y: -20 }}
        ...
        <div className="w-full md:w-1/2 p-8 md:p-10 flex flex-col justify-center">
          ...
          >
            ...
            <p className="text-gray-400 mb-8">Join us and start chatting in real time</p>
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-[#090b13] text-gray-400"> </span>
              </div>
            </div>
            </motion.div>
            ...
            <form className="space-y-3" onSubmit={handleSignUp}>
              ...
              <div className="text-center mt-6">
                <a href="/login" className="text-blue-500 hover:text-blue-400 text-sm transition-colors">
